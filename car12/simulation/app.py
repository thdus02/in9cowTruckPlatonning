...
# ======= 모든 차량이 주차될 때까지 대기 =======
# ======= 모든 플래투닝 트럭(Veh0~Veh3)이 각자 주차장에 들어와야 UI 표시 =======
...
def run():
    ...
    root = tk.Tk()
    # ★ 창 생성 직후 위치 지정
    root.geometry("+100+50")   # 예: 위쪽 중앙 정도
    root.title("Truck Platooning – Real-Time Dashboard")
    colors = ["red", "orange", "yellow", "green", "blue", "purple", "pink"]

      # ★ 여기서 bg_random 차량 필터링: Veh* 만 UI 대상
    all_vehicles = [
    ...
    # (추가) 체인 콜백: UI에서 Leader/Follower 콤보박스 갱신용
