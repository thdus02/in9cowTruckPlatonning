...
def build_gap_labels(root):
    ...
    thw1 = tk.Label(root, text="Headway F1: — s", font=("Arial", 12), fg="gray"); thw1.grid(row=4, column=0, columnspan=3)
    thw2 = tk.Label(root, text="Headway F2: — s", font=("Arial", 12), fg="gray"); thw2.grid(row=5, column=0, columnspan=3)
    return gap1, gap2, thw1, thw2
